...
interface MyPointsPagePreviewProps {
  campaignData: CampaignFormData;
}

const mockPointBalance = 1250; // Using mock data for preview
...
export default function MyPointsPagePreview({ campaignData }: MyPointsPagePreviewProps) {
  return (
          ...
          <TabsContent value="balance">
            <Card>
              ...
              <CardContent className="text-center">
                <p className="text-6xl font-bold text-orange-600">{mockPointBalance}</p>
