  ...
  useEffect(() => {
    if (campaign && !dataLoaded) {
      ...
      updateFormData({
        ...
        totalSlots: getField('total_slots', 'total_slots') ??
                   (isBusinessCampaign(currentCampaign) ? currentCampaign.total_slots : currentCampaign.total_slots) ??
                   currentCampaign.quantity ?? 0,
