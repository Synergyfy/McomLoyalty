  ...
  if (isError || !campaign) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center text-center gap-4 px-4 bg-gray-50">
        <p className="text-red-500 font-medium">Error loading earn points info.</p>
        <button
          onClick={() => refetch()}
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-10">
          <h1 className="text-4xl font-extrabold text-gray-900 mb-4">{campaign.earnPointPageTitle || 'Earn Points'}</h1>
          <p className="text-lg text-gray-600">{campaign.earnPointPageDescription || 'Choose a method to earn points for this campaign.'}</p>
        </div>
        {/* Earn Methods Grid */}
